(function () {
  ...
  var WHATSAPP_PHONE = "923193677763";
  ...
  form.addEventListener("submit", function (e) {
    ...
    var projectType = form.elements.project_type.value;
