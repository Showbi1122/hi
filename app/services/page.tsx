  ...
  return (
    <div className="site site-black site-inner">
      ...
      <main id="main-content">
        <InnerPageHero title="Service" current="Service" watermark="service" />

        {/* Intro + full service grid — Glint service-primery */}
        <section
            ...
            <div className="row">
              {services.map((service, index) => (
                ...
                >
                  <article
                    id={service.id}
                    className={`single-service pricing2 ${
                      index % 3 === 1 ? "active" : ""
                    }`}
                  >
                    <Link
        ...
        {/* Detail blocks — dark Glint section */}
        <section className="service-details-area section-padding" id="details">
          <div className="glint-container">
            <div className="row items-center">
              <div className="col-lg-6">
                <div className="heading white">
                  <strong className="filltext">details</strong>
                  <small>WHAT YOU GET</small>
                  <h2>
                    Clear scope for <span>every service</span>
                  </h2>
                </div>
              </div>
              <div className="col-lg-6">
        ...
        {/* Process — same language as homepage */}
        <section
          ...
          <div className="glint-container">
            <div className="row items-center">
              ...
              <div className="col-lg-6">
                <div className="info-content">
                  <p>
                    From first message to live website, here&apos;s how we&apos;ll work
                    together.
                  </p>
                </div>
              </div>
