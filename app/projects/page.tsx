...
function fullImage(src: string) {
  return src.replace("-600.webp", ".webp");
}
          ...
          <div className="single-portfolio-description">
              ...
              <table className="table table-borderless">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>: {project.title.replace(/ Website.*$/, "").replace(/ Web App$/, "")}</td>
                  </tr>
                  <tr>
            ...
            {project.liveUrl ? (
              <a
                ...
                style={{ marginTop: 20 }}
              >
                Visit site <i className="cbtn-ico">→</i>
              </a>
            ) : (
              <Link href="/contact" className="cbtn cbnt1" style={{ marginTop: 20 }}>
                Start similar project <i className="cbtn-ico">→</i>
              </Link>
            )}
          </div>
        </div>
  ...
  return (
    <div className="site site-black site-inner">
      ...
      <main id="main-content">
        <InnerPageHero title="Portfolio" current="Portfolio" watermark="Portfolio" />

        <section className="portfolio-area inner-bg-shpes section-padding">
          ...
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/assets/ui/inner-bg1.svg" alt="" className="inner-shape2" />
        </section>
            ...
            <div className="row">
              <div className="col-lg-6 m-auto text-center">
                <div className="primery-heading cta-heading">
                  ...
                  <h2>
                    Ready to start your next <span>project?</span>
                  </h2>
                </div>
