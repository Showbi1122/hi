...
function CalendarIcon() {
  return (
    <svg className="meta-ico" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden>
...
function PostCard({ post }: { post: BlogPostMeta }) {
  return (
    <article className="single-blog-section">
      <Link
        href={`/blog/${post.slug}`}
        className="single-blog-section-img"
        style={{ backgroundImage: `url(${post.featuredImage})` }}
        aria-label={post.imageAlt}
      >
        <span className="single-blog-section-img-tag">{post.tag}</span>
      </Link>
      <div className="single-blog-section-description blog-box">
        <h2>
          <Link href={`/blog/${post.slug}`}>{post.headline}</Link>
        </h2>
        <div className="single-blog-section-author">
          <ul>
            <li>
              <Link href="/about" className="blog-author">
                <Image
        ...
        <div className="blog-readmore-social">
          <div className="row items-center">
            <div className="col-sm-6 align-self-center">
              <Link href={`/blog/${post.slug}`} className="cbtn cbnt1">
                read more <i className="cbtn-ico">→</i>
              </Link>
            </div>
            <div className="col-sm-6 text-right align-self-center">
              <div className="blog-page-social">
                <ul>
                  {compactSocialIcons.map((s) => (
                    <li key={s.href}>
                      <a
                        href={s.href}
                        target="_blank"
  ...
  return (
    <div className="site site-black site-inner">
      ...
      <main id="main-content">
        <InnerPageHero title="Blog" current="blog" watermark="blog" />

        <section className="blog-page-area inner-bg-shpes section-padding">
          <div className="glint-container">
            <div className="row">
              <div className="col-lg-8">
                <div className="blog-page-left mr-lg-4">
                  {posts.map((post) => (
                  ...
                  <div className="blog-banner">
                    <h3>
                      Need a developer who ships clean product and SEO content?{" "}
              ...
              <div className="col-lg-4">
                <aside className="blog-page-right text-center">
                  <div className="blog-box blog-author">
                    ...
                    <div className="blog-author-description">
                      <p>
                        Hello — I&apos;m {AUTHOR.name}. I build custom websites, POS
                        systems, and SaaS products, and write about the decisions behind
                        them.
                      </p>
                      <div className="blog-page-social">
                        <ul>
                  ...
                  <div className="blog-box blog-post">
                    <h3>
                      Recent Posts <span>.</span>
                    </h3>
                    <div className="border-effect" />
                    {posts.slice(0, 4).map((post) => (
                      <div key={post.slug} className="single-blog-post">
                        <Image
                  ...
                  <div className="blog-box blog-categores">
                    <h3>
                  ...
                  <div className="blog-box blog-tag">
                    <h3>
                      Tags <span>.</span>
                    </h3>
                    <div className="border-effect" />
                    <ul>
                      {[...new Set([...tags, "Next.js", "Business", "Performance"])].map(
                        (tag) => (
                          <li key={tag}>
                            <span>{tag}</span>
                          </li>
