import { NewsletterSignup } from "@/components/analytics/NewsletterSignup";
            ...
            <div className="row">
              ...
              <div className="col-lg-4">
                <aside className="blog-page-right text-center">
                  ...
                  <div className="blog-box blog-tag text-left">
                    <h3>
                      Newsletter <span>.</span>
                    </h3>
                    <div className="border-effect" />
                    <NewsletterSignup location="blog_sidebar" />
                  </div>
